...
Last updated: 2026-08-24 (E36f: neff_ranked policy S2 re-verification. S2 FAIL in 3 new cells at ti=5s (dynamic-L mixed-fleet effect; new failure pattern); E36e's kv=18GiB ti≥30s cells now PASS. S3 PASS (+0.2–16.4pp vs fp_ranked). neff_ranked is a regime-conditional design rule: choose full at ti≤6s, win10 at ti>crossover. 0/16 cells selection-distinguishable from fixed policies; 11/16 outcome-distinguishable; honest activation 11/16. E36e results unchanged.
