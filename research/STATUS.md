...
Last updated: 2026-09-22 (Study K — Reasoning gate on ERQA, COMPLETE. GATE FAILS: THINKING (Qwen3-VL-4B-Thinking, 3 seeds) 45.1% vs INSTRUCT (4B-Instruct) 42.0%, diff=+2.50pp, 95%CI=[−4.2,+9.2], p=0.3865, n.s. at α=0.05. Replication PASS: INSTRUCT +0.7pp vs 41.3 published, THINKING −2.2pp vs 47.3 published. THINKING-QUICK 45.8% ≈ THINKING (diff=+0.25pp, p=1.00; median latency 8.5s vs 11.1s — quick suffix reduces tokens but not accuracy). Position bias material for both arms (−3.2pp INSTRUCT, −3.0pp THINKING). Think tokens negatively correlated with correctness (r=−0.12, p<0.001). Decoding defect corrected: initial greedy run invalidated; corrected to model-card sampling (temperature=0.6, top_p=0.95, top_k=20). Report: reports/study_k_erqa.md.)
