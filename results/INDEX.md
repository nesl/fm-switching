...
| `results/cost/vllm_calibration_a6000_qwen7b.json` | `experiments/cost/vllm_calibration.py` | `qwen7b` | a6000 | L ∈ {1k,8k,32k,64k} × 5 reps; cold + decode (80,200 tok); L≥32k infeasible (RoPE OOB) | cold: vLLM 1.15× faster; decode ~43 tok/s, 1.2–1.8× faster; window-vs-summary gap 90× at L=8k under vLLM; HF cost model conservative by ~15% | 2026-08-21 |
