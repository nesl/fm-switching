...
| `results/cost/vllm_calibration_a6000_qwen7b.json` | `experiments/cost/vllm_calibration.py` | `qwen7b` | a6000 | L ∈ {1k, 8k} × 5 reps (32k infeasible: prompt overshoot); prefix_caching=False | vLLM TTFT: 0.146s@1k, 1.153s@8k; HF baseline: 0.165s, 1.369s; ratio 1.13–1.19× (vLLM slightly faster); simulator cost model is conservative | 2026-08-20 |
